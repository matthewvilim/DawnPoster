...
\head{Increasing Dynamism in Plasticine}{\auth{Alexander Rucker}{acrucker@stanford.edu}\and\auth{Yaqi Zhang}{yaqiz@stanford.edu}\and\auth{Matthew Vilim}{mvilim@stanford.edu}}\\[0.75in]
...
\splitcolh{0.4\columnwidth}{20in}{
  \rulebox{Hybrid Networks}{
    ...
    %\textbox{
      \bigidea{How to improve link utilization given communication characteristics?}
      \begin{itemize}
