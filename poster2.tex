...
\splitcol{0.3\columnwidth}{
  \rulebox{Background}{
    \emph{Plasticine} a vectorized Coarse-Grained Reconfigurable Array with
    \begin{itemize}
  ...
  \rulebox{Compiler \& Mapping Flow}{
    ...
    \vspace{20pt}
    \includegraphics[width=0.8\linewidth]{figs/mapping.pdf}\\
  }
}
\splitcol{0.4\columnwidth}{
