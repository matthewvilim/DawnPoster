...
\begin{figure}[H]
\caption{Frequency/Error Rate Trade-off for Cores}
\centering
\begin{tikzpicture}
\begin{axis}[xlabel=frequency (\si{{\giga\hertz}}), ylabel=error rate (ER), legend pos= north west, width=0.8\linewidth]
\addplot[color=black,solid,mark=o] table [x index = {0}, y index = {1}, col sep=comma] {data/rpl_freq_error.txt};
\addlegendentry{RCA}
\addplot[color=black,dashed,mark=*] table [x index = {0}, y index = {1}, col sep=comma] {data/cla_freq_error.txt};
\addlegendentry{CLA}
\addplot[color=black,dotted,mark=x,mark options={solid}] table [x index = {0}, y index = {1}, col sep=comma] {data/gda_freq_error.txt};
\addlegendentry{GDA\textsubscript{(1,4)}}
\addplot[color=black,solid,mark=x] table [x index = {0}, y index = {1}, col sep=comma] {data/ksa32_freq_error.txt};
\addlegendentry{KSA\textsubscript{32}}
\addplot[color=black,dotted,mark=o,mark options={solid}] table [x index = {0}, y index = {1}, col sep=comma] {data/ksa16_freq_error.txt};
\addlegendentry{KSA\textsubscript{16}}
\end{axis}
\end{tikzpicture}
\label{fig:freq_scaling}
\end{figure}

\begin{figure}[H]
\centering
\caption{Frequency/Profit Trade-off for Cores}
\label{fig:profit_freq}
\begin{tikzpicture}
\begin{axis}[xlabel=frequency (\si{{\giga\hertz}}), ylabel=profit (\si{USD\per\second}), legend pos= south west, width=0.8\linewidth]
\addplot[color=black,solid,mark=o] table [x index = {0}, y index = {1}, col sep=comma] {data/rpl_freq_profit.txt};
\addlegendentry{RCA}
\addplot[color=black,dashed,mark=*] table [x index = {0}, y index = {1}, col sep=comma] {data/cla_freq_profit.txt};
\addlegendentry{CLA}
\addplot[color=black,dotted,mark=x,mark options={solid}] table [x index = {0}, y index = {1}, col sep=comma] {data/gda_freq_profit.txt};
\addlegendentry{GDA\textsubscript{(1,4)}}
\addplot[color=black,solid,mark=x] table [x index = {0}, y index = {1}, col sep=comma] {data/ksa32_freq_profit.txt};
\addlegendentry{KSA\textsubscript{32}}
\addplot[color=black,dotted,mark=o,mark options={solid}] table [x index = {0}, y index = {1}, col sep=comma] {data/ksa16_freq_profit.txt};
\addlegendentry{KSA\textsubscript{16}}
\end{axis}
\end{tikzpicture}
\end{figure}
